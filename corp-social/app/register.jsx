...
export default function Register() {
    ...
    const onCreate = async () => {
        try {
            ...
            // TODO: Conectează la Supabase (exemplu)
            ...
            // await supabase.from('profiles').insert({ id: signUp.user.id, full_name: fullName });
        ...
        <Screen style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <View style={styles.wrap}>
                <View style={styles.pill}>
                    <Text style={styles.pillText}>create account</Text>
                </View>

                {/* CARD cu blur uniform gri */}
                <BlurView intensity={60} tint="dark" style={styles.glass}>
                    ...
                    <Text style={styles.helper}>
                        Ai deja cont? <Link href="/login" style={styles.link}>Log in</Link>
                    </Text>
                </BlurView>
            </View>
        </Screen>
...
const styles = StyleSheet.create({
    ...
    overlay: {
        ...
        backgroundColor: 'rgba(45,45,45,0.55)', // gri uniform
    },
